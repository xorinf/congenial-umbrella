    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
      ...
      <div className="absolute top-[180px] left-[3%] hidden lg:block" style={{ pointerEvents: 'none' }}>
        <svg width="30" height="450" viewBox="0 0 30 450" fill="none" style={{ opacity: 0.12 }}>
          <path d="M15 0 C20 60, 10 120, 15 180 C20 240, 10 300, 15 360 C18 400, 15 440, 15 450" stroke="#b8a080" strokeWidth="1.5" strokeDasharray="6 8" fill="none" strokeLinecap="round"/>
        </svg>
      </div>
    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
      ...
      <div className="absolute top-[170px] right-[4%] hidden lg:block" style={{ pointerEvents: 'none' }}>
        <svg width="24" height="400" viewBox="0 0 24 400" fill="none" style={{ opacity: 0.1 }}>
          <path d="M12 0 C16 50, 8 100, 12 150 C16 200, 8 250, 12 300 C14 350, 12 380, 12 400" stroke="#b8a080" strokeWidth="1.5" strokeDasharray="6 8" fill="none" strokeLinecap="round"/>
        </svg>
      </div>
